...
function App() {
  ...
  return (
    <>
      ...
      {canShowSidebar && <div>  {showSidebar ? <SideBar toggleSidebar={()=>toggleSidebar(!showSidebar)} /> : <div onClick={()=>toggleSidebar(!showSidebar)} className="absolute top-8 left-2  self-start bg-blue-950 p-1 rounded-md">
           <MenuIcon
              sx={{
