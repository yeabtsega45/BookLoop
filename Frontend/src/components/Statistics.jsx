...
function Statistics() {
  return (
    <div className="w-[318px] h-full  bg-primary-contrast px-4 pb-24 rounded-2xl ">
      ...
      <div className="flex flex-col pb-9 px-6 rounded shadow-2xl">
        ...
        <div className="flex mb-2 justify-between">
          <h1 className="text-[28px] font-bold">ETB 9460.00</h1>
          <div className=" flex">

          <p className="text-[#FF2727] text-[16px] font-medium  flex text-nowrap self-end">↓ 1.5%</p>
          </div>
        </div>
